                ...
                <div class="totalForm">
                    ...
                    <form action="../backend/update.php" method="POST">
                        <div class="submit_btn">
                            <input type="Submit" name="Update" value="Update" id="submit-css" class="btn-submit btn-white-submit btn-animate-submit" id="subtn">
                        </div>
                        <!-- <div class="choose">
                            ...
                            <span class="checkbox" id="locationcheck">
                            ...
                            <span class="checkbox" id="personcheck">
                        ...
                        <div class="formnew" id="initial">
                            ...
                            <div class="firstDiv">
                                <div class="input-container">
                                    <input type="text" required="" name="pono" value="<?php echo "$po_no"?>"/>
                                    <label>Product Number</label>
                                </div>
                                <div class="input-container">
                                    <input type="mail" required="" name="dname" value="<?php echo "$d_name"?>"/>
                                    <label>Device Name</label>
                                </div>
                                <div class="input-container">
                                    <input type="mail" required="" name="dconfig" value="<?php echo "$d_config"?>"/>
                                    <label>Device Configuration</label>
                                </div>
                            </div>
                            <div>
                                <div class="input-container">
                                    <input name="serial-1" type="text" required="" value="<?php echo "$srno"?>"/>
                                    <label>Serial No</label>
                                </div>
                                <div class="input-container">
                                    <input type="number" required="" name="cost" value="<?php echo "$cost"?>"/>
                                    <label>Cost</label>
                                </div>
                                <div class="input-container">
