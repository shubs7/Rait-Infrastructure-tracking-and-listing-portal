...
function select()
{
  ...
  if(decide == 1)
  {
    ...
    // document.querySelector('#locationcheck1').style.display='none'
    // document.querySelector('#personcheck1').style.display ='inline-flex'
  }
  else{

    document.querySelector('#location').style.display='block'
    document.querySelector('#person').style.display ='none'
    // document.querySelector('#locationcheck1').style.display='inline-flex'
    // document.querySelector('#personcheck1').style.display ='none'
  }
}
